...
- Saved record details offer a read-only plan whose two tabs remain navigable. Backup and cloud snapshots retain the current batch. Brewing CSV includes target-sheet and process-measurement JSON columns. All editing devices must use v90 or later.
