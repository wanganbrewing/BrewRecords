(function(root,factory){
  ...
  const FIELD_DEFS=[
    ['基本','batchName','バッチ名','text',''],['基本','style','スタイル','text',''],['基本','brewDate','仕込み予定日','date',''],['基本','brewer','担当者','text',''],['基本','batchSize','予定仕込み量','number','L'],
  ...
  const WATER_DEFS=[
    ...
    ['原水','waterSource','水源','text','','bound'],['原水','waterPh','原水pH','number','','bound'],['原水','waterAlkalinity','原水アルカリ度','number','mg/L as CaCO₃','bound'],['原水','targetWaterPh','目標仕込み水pH','number','','bound'],
