(function(root){
  ...
  const fields=[
    ...
    ['yeastSource','酵母の由来（fresh pitch等）','text'],['yeastHarvestDate','酵母回収予定日','date'],
  ...
  const steps=[
    ...
    ['lauterRest','ろ過前の静置（Lauter rest）','duration'],['grant','ろ過麦汁の受け入れ','time,volume'],['recirculation','麦汁循環','duration'],
    ['flow','煮沸釜への移送流量','flow'],['kwtStart','煮沸釜への充填開始','time'],['firstRun','初流麦汁（First Run）','gravity,ph'],
